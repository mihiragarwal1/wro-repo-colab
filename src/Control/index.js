...
function downloadFrame() {
    ...
    a.download = `Cam-img_${current.getHours()}-${current.getMinutes()}_${current.getMonth()}-${current.getDay()}-${current.getFullYear()}.png`;
    a.click();
};
function downloadSession() {
    ...
    a.href = data;
    let current = new Date();
    a.download = `data_${current.getHours()}-${current.getMinutes()}_${current.getMonth()}-${current.getDay()}-${current.getFullYear()}.json`;
    a.click();
};
