...
def findStartingPosition(leftHeights, rightHeights):
    ...
    frontWall = (leftHeights[380] + rightHeights[preProcessingController.imageWidth - 1 - 380]) / 2 #13 #18 for closeup
    leftWall = leftHeights[56] #55
    rightWall = rightHeights[preProcessingController.imageWidth - 1 - 56] #55
    # long = 29
